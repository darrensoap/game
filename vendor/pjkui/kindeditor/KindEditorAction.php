 ...
 *          'config' => [
 *              "php_path" =>\Yii::getAlias('@frontend')."/web",
 *              "php_url"  => "http://www.yii2sg.com",//图片访问路径前缀
 *              "imagePathFormat" => "/uploads/goodsimg/{yyyy}{mm}{dd}" //上传保存路径
 *          ],
 *      ],
 *  ];
 */
...
class KindEditorAction extends Action {
    ...
    public $max_size;
    public $oriName;
    public $pathFormat = "/uploads/goodsimg/{yyyy}{mm}{dd}";
    ...
    public function init() {
       ...
       // $this->php_path =  $_SERVER['DOCUMENT_ROOT'] . '/';
        $this->php_path =isset($this->config['php_path'])?$this->config['php_path']:$_SERVER['DOCUMENT_ROOT'];
        $this->php_url = isset($this->config['php_url'])?$this->config['php_url']:'/';
        $this->pathFormat = isset($this->config['pathFormat'])?$this->config['pathFormat']:$this->pathFormat;
...
//            ),
    ...
    public function UploadJosnAction() {
        ...
        if (empty($_FILES) === false) {
            ...
            $this->save_path = $this->php_path . $fullName;
            //文件保存目录URL
            $this->save_url = $this->php_url . $fullName;
